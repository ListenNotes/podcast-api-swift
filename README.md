...
The Podcast API Swift library provides convenient access to the [Listen Notes Podcast API](https://www.listennotes.com/podcast-api/) from
...
**Table of Contents**
- [Podcast API Swift Library](#podcast-api-swift-library)
  - [Installation](#installation)
    - [CocoaPods](#cocoapods)
    - [Swift Package Manager](#swift-package-manager)
    - [Requirements](#requirements)
  - [Usage](#usage)
    - [synchronousRequest parameter](#synchronousrequest-parameter)
    - [Update UI in the main thread](#update-ui-in-the-main-thread)
    - [Handling errors](#handling-errors)
    - [Run example apps](#run-example-apps)
      - [Run the command line example app](#run-the-command-line-example-app)
      - [Run the iOS example app](#run-the-ios-example-app)
...
```swift
dependencies: [
    .package(url: "https://github.com/ListenNotes/podcast-api-swift.git", .upToNextMajor(from: "1.1.0"))
]
```
...
// For all parameters, please refer to https://www.listennotes.com/podcast-api/docs/
...
If `apiKey` is an empty string "", then we'll connect to a [mock server](https://help.listennotes.com/en/articles/5224500-how-to-test-the-podcast-api-without-an-api-key) that returns fake data for testing purposes.
...
parameters["id"] = "914a9deafa5340eeaa2859c77f275799"
parameters["safe_mode"] = "1"        
...
parameters["ids"] = "3302bc71139541baa46ecb27dbf6071a,68faf62be97149c280ebcc25178aa731,9cf19c590ff0484d97b18b329fed0c6a"      
...
parameters["domain_name"] = "nytimes.com"
